PRODUCT_BUILD_PROP_OVERRIDESPRODUCT_BUILD_PROP_OVERRIDES += BUILD_UTC_DATE=0
...
# Set all versions
CARDINAL_VERSION := Cardinal-AOSP-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MAINTENANCE).$(PRODUCT_VERSION_MINOR)-$(CARDINAL_BUILD_TYPE)$(CARDINAL_POSTFIX)
